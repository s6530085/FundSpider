...
class IndexMain(object):
    ...
    def output_standard_index(self):
        ...
        self.outputer.standard_output(self.analysis.query_indexs(
            ...
            show_mean=True,
            direct_show=True)
        # self.outputer.standard_output(self.analysis.query_indexs(['000905', '000852', '399101'], IndexCollector.ATTENTION_SECTOR_INDEXS_BEGIN_DATE), show_mean=True, direct_show=True)
