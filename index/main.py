...
class IndexMain(object):
    ...
    def output_standard_index(self):
        ...
        self.outputer.standard_output(self.analysis.query_indexs(IndexCollector.TEST_ATTENTION_INDEXS, IndexCollector.TEST_INDEXS_BEGIN_DATE), IndexCollector.TEST_INDEXS_BEGIN_DATE, show_mean=True, direct_show=True)
