...
class IndexCollector(object):
    ...
    ATTENTION_SECTION_INDEXS = ['000978', '399812', '000827', '000922', '000990', '399396']

    ATTENTION_INDEXS = ATTENTION_BROAD_INDEXS + ATTENTION_SECTION_INDEXS
    ATTENTION_BROAD_INDEXS_BEGIN_DATE = '2004-01-01'
    ATTENTION_SECTION_INDEXS_BEGIN_DATE = '2011-01-01'

    TEST_ATTENTION_INDEXS = ['000978']
