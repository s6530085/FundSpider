...
class IndexCompareCollector(object):
    ...
    def __init__(self):
        self.db = sqlite3.connect(IndexCompareCollector.DATABASE_NAME)
        ...
        '''.format(IndexCompareCollector.DATABASE_TABLE_NAME,\
                   FundInfo.CODE_KEY,\
                   FundInfo.NAME_KEY,\
        ...
        '''.format(IndexCompareCollector.DATABASE_TABLE_NAME, FundInfo.CODE_KEY))
